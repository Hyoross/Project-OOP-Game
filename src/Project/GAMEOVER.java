...
public class GAMEOVER extends JPanel {
    private ImageIcon background = new ImageIcon(this.getClass().getResource("endback.png"));
    ...
    public void paintComponent(Graphics g){
        ...
        g.setFont(new Font("Playtime",Font.CENTER_BASELINE,100));
        g.setColor(Color.WHITE);
        g.drawString("GAME OVER",200,100);
        g.setColor(Color.WHITE);
        g.setFont(new Font("Playtime",Font.CENTER_BASELINE,60));
        g.drawString("SCORE : "+last,320,200);
    }
}
